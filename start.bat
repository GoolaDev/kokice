...
start "" /B %bindir%\QuickPHP\QuickPHP.exe /Minimized /ShowtrayIcon=true /Bind=%bindIp% /Port=%Port% /Root=%webroot% /AllowDirList=false /PHPMaxSecs=0 /NoConfirm=true /Start /StartBrowser
TIMEOUT /T 5
